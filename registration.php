    ...
    <div class="navigation">
      <div class="container">
        <nav class="nav">
          ...
          <div class="nav__menu">
            <div class="menu__top">
              <span class="nav__category">PHONE STORES</span>
          ...
          <div class="nav__icons">
            <ul class="nav__list" style="margin-right: 15px;">
              <li class="profil_li">
                <a href="#contact" class="profil"><?php echo $_SESSION['name']; ?></a>
              </li>
            </ul>
          ...
          <ul class="glide__slides">
            <li class="glide__slide">
              <div class="hero__center">
                <div class="hero__left">
                  ...
                  <a href="Smart_iphone_13_RU.pdf" download><button class="hero__btn">SHOP NOW</button></a>
                </div>
                <div class="hero__right">
                  <div class="hero__img-container">
                    <img class="banner_01" src="./img/banner_01.png" alt="banner2" />
                  </div>
                </div>
              </div>
            </li>
            <li class="glide__slide">
              <div class="hero__center">
                ...
                <div class="hero__right">
                  <img class="banner_02" src="./img/banner_02.png" alt="banner2" />
                </div>
              </div>
            </li>
          </ul>
        ...
        <div class="collection__container" data-aos="fade-up" data-aos-duration="1200">
          <div class="collection__box">
            <div class="img__container">
              <img class="collection_02" src="./img/collection_02.png" alt="">
            </div>
          ...
          <div class="collection__box">
            <div class="img__container">
              <img class="collection_01" src="./img/collection_01.png" alt="">
            </div>
            <div class="collection__content">
              <div class="collection__data">
            ...
            <ul class="glide__slides">
              ...
              <li class="glide__slide">
                <div class="testimonial__box">
                  ...
                  <div class="client__info">
                    <h3>Stor</h3>
                    <span>Founder at Phone Store</span>
                  </div>
                </div>
